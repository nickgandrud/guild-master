...
# Store the color for each brushpoint
# at a particular point in space.
# The table gives where the colors are encoded.
COLOR_POS = {
...
def make_gcode(input_file, output_file):
    ...
    for line in input_stream:
        ...
        if len(line) == 0:
            ...
            out.write(refill(split_line[1], split_line[2],
                             split_line[3], position_xy))
